...
\item A large prime number $p$, an Elliptic Curve $E$ over $F_p$ and a point $P \in E(F_p)$  is shared between Ram and Shayam over public channel.
 ...
 One of the drawback of this method is to attach plain text to a point in $ E(F_p)$. One of the proposed solution for this is to use probablistic algorithm \cite{7033751} for this with a small chance of failure.
\end{enumerate}
\cleardoublepage
